...
static const int64 MIN_TX_FEE = uCOIN;
static const int64 MIN_RELAY_TX_FEE = uCOIN;
static const int64 MAX_MONEY = 2000000000 * COIN;
static const int64 MAX_MINT_PROOF_OF_WORK = 9999 * COIN;
static const int64 MIN_TXOUT_AMOUNT = MIN_TX_FEE;
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
static const int COINBASE_MATURITY_PPC = 500; // Adapted for Peershares - same as it is set in Bitcoin, where Peercoin is 500
// Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp.
static const int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC
static const int STAKE_TARGET_SPACING = 60 * 1; // peershares: 30 minute block spacing
static const int STAKE_MIN_AGE = 60 * 60 * 8 ; // peershares: Minimum age for coin age changed to 3 days
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 90; // peershares: Stake age of full weight
static const int64 IPO_SHARES = 2500000000 * COIN; // peershares: Total number of shares to create using proof of work (intented for IPO)
static const int64 PROOF_OF_WORK_BLOCKS = 625; // peershares: Block height of the last proof of work block
