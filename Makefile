#############################################################################
# Makefile for building: ybcoin
# Generated by qmake (2.01a) (Qt 4.8.6) on: Tue Sep 1 18:40:17 2015
# Project:  ftcoin_pos.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile ftcoin_pos.pro
#############################################################################
...
SOURCES       = src/qt/bitcoin.cpp \
		...
		src/scanbalance.cpp \
		src/qt/distributedivdialog.cpp build/moc_bitcoingui.cpp \
		...
		build/moc_distributedivdialog.cpp \
		qrc_bitcoin.cpp
OBJECTS       = build/bitcoin.o \
		...
		build/moc_distributedivdialog.o \
		build/qrc_bitcoin.o
...
Makefile: ftcoin_pos.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o Makefile ftcoin_pos.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/ybcoin0.1.0.0 || $(MKDIR) build/ybcoin0.1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/ybcoin0.1.0.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_fr_FR.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/ybcoin0.1.0.0/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/messagepage.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/compat.h src/util.h src/uint256.h src/serialize.h src/strlcpy.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/irc.h src/mruset.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/qtipcserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/kernel.h src/distribution.h src/qt/distributedivdialog.h build/ybcoin0.1.0.0/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/ybcoin0.1.0.0/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/addressbookpage.cpp src/qt/messagepage.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/version.cpp src/util.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/irc.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/json/json_spirit_writer.cpp src/json/json_spirit_value.cpp src/json/json_spirit_reader.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/qtipcserver.cpp src/qt/rpcconsole.cpp src/kernel.cpp src/distribution.cpp src/scanbalance.cpp src/qt/distributedivdialog.cpp build/ybcoin0.1.0.0/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/messagepage.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/distributedivdialog.ui build/ybcoin0.1.0.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_fr_FR.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/ybcoin0.1.0.0/ && (cd `dirname build/ybcoin0.1.0.0` && $(TAR) ybcoin0.1.0.0.tar ybcoin0.1.0.0 && $(COMPRESS) ybcoin0.1.0.0.tar) && $(MOVE) `dirname build/ybcoin0.1.0.0`/ybcoin0.1.0.0.tar.gz . && $(DEL_FILE) -r build/ybcoin0.1.0.0
...
genbuildhook: FORCE
	cd /home/lc/peer/ftc-master; /bin/sh share/genbuild.sh /home/lc/peer/ftc-master/build/build.h
...
build/moc_distributedivdialog.cpp: src/util.h \
		src/uint256.h \
		src/netbase.h \
		src/serialize.h \
		src/allocators.h \
	...
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/distributedivdialog.h -o build/moc_distributedivdialog.cpp
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/images/peershares_splash.png \
		...
		src/qt/res/icons/ftcshares.png \
		src/qt/res/icons/filesave.png \
		src/qt/res/icons/transaction2.png \
		src/qt/res/icons/peershares_testnet.png \
...
build/ui_distributedivdialog.h: src/qt/forms/distributedivdialog.ui
	/usr/lib/x86_64-linux-gnu/qt4/bin/uic src/qt/forms/distributedivdialog.ui -o build/ui_distributedivdialog.h
...
build/distribution.o: src/distribution.cpp src/util.h \
		src/uint256.h \
		src/netbase.h \
		src/serialize.h \
		src/allocators.h \
		...
		src/bignum.h \
		src/key.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/distribution.o src/distribution.cpp

build/scanbalance.o: src/scanbalance.cpp src/db.h \
		src/main.h \
		src/bignum.h \
		src/util.h \
		src/uint256.h \
		...
		src/distribution.h \
		src/json/json_spirit_value.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/scanbalance.o src/scanbalance.cpp

build/distributedivdialog.o: src/qt/distributedivdialog.cpp src/qt/distributedivdialog.h \
		src/util.h \
		src/uint256.h \
		src/netbase.h \
		src/serialize.h \
		...
		src/key.h \
		src/json/json_spirit_value.h \
		build/ui_distributedivdialog.h \
		src/scanbalance.h \
		src/json/json_spirit_writer_template.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/distributedivdialog.o src/qt/distributedivdialog.cpp
...
build/moc_distributedivdialog.o: build/moc_distributedivdialog.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_distributedivdialog.o build/moc_distributedivdialog.cpp
